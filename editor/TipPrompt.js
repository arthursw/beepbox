...
//namespace beepbox {
var button = elements_strict_1.HTML.button, div = elements_strict_1.HTML.div, p = elements_strict_1.HTML.p, h2 = elements_strict_1.HTML.h2;
var TipPrompt = (function () {
    function TipPrompt(_doc, type) {
        var _this = this;
        this._doc = _doc;
        this.readonly = _closeButton;
        ...
        this.cleanUp = function () {
            _this._closeButton.removeEventListener("click", _this._close);
        };
        var message;
        switch (type) {
            case "scale":
        ...
        setTimeout(function () { return _this._closeButton.focus(); });
        this._closeButton.addEventListener("click", this._close);
    }
    return TipPrompt;
})();
exports.TipPrompt = TipPrompt;
//}
